  ...
  return (
    <footer className="bg-gray-900 text-white py-12 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        {/* Quick Links */}
        <div>
          <h3 className="text-lg font-semibold mb-4 text-[#7ce7ff]">Quick Links</h3>
        ...
        {/* Contact */}
        <div>
          <h3 className="text-lg font-semibold mb-4 text-[#7ce7ff]">Contact Us</h3>
        ...
        {/* Newsletter */}
        <div>
          <h3 className="text-lg font-semibold mb-4 text-[#7ce7ff]">Subscribe to Newsletter</h3>
          ...
          <form onSubmit={handleSubscribe} className="flex flex-col space-y-2">
            <input
              ...
              className="p-2 rounded-lg border border-gray-700 bg-gray-800 text-white focus:outline-none focus:border-[#28af5b]"
              required
            />
            <button
              type="submit"
              className="px-4 py-2 bg-[#01495F] text-white rounded-lg hover:opacity-90 transition duration-300"
            >
              Subscribe
            </button>
          </form>
      ...
      <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
        <div className="flex space-x-4 mb-4 md:mb-0">
          <a href="#" className="text-gray-400 hover:text-[#28af5b] transition duration-300">
        ...
        <div className="text-gray-500 text-xs">
          <p>Grievance Redressal Officer: <a href="#" className="underline hover:text-[#deeea5]">Contact GRO</a></p>
